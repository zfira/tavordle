...
////////* Variables: *///////
let  listOfMessages = ["על שמו נקרא פורום הלייז האגדי",
                       "אחד מהיורקים הגדולים שידעה אשדר וכינויו של אחד מהפרובוקטורים הגדולים שיצאו מהכפר",
                       "מוכרת נקניקיות ואישתו של האחד והיחיד, כל אחד מאיתנו סוחב משהו ממנה איתו",
                       "קצבייה בינונית וכינויו המקורי של תירס. אגדת טניס שולחן מקומית ואח של פצצה",
                       "עוד כינוי טראומטי שככל הנראה הכניס הרבה כסף לפסיכולוגית ברת מזל (מר כוס?). אח של פצצה",
                       "קצבייה בינונית וכינויו המקורי של תירס. אגדת טניס שולחן מקומית ואח של פצצה",
                       "כדורסלן בינוני, מעולם לא חזר לעצמו לאחר המפגש המצער עם ארנון ארדיטי. אח של פצצה",
                       "אחד מהתורמים הגדולים של ליגת המלאכים, חבר במועדון ה200 הבזוי עוד לפני שהיה מועדון 200. אח של פצצה",
                       "בן טיפוחיו של דיוויד שטרן, קומישינר ודיקטטור. אח של פצצה",
                       "בן טיפוחיו של המאמן חנן שטרן, סקוטי פיפן של הציונות הדתית",
                       "מאמן החרמנים, עוד לא נולדה המורה שתקריא את השם שלו נכון. מעולם לא שילם את חובו למישל",
                       "הנרגילה האגדית של דויבד. נזכור גם את ענת, נרגילה אגדית לא פחות, שנסיבות מותה לא התגלו עד היום",
                       "מאמן כדורסל בינוני, רצח את משהנה בדם קר. שילם על כך בנוקיה 3100",
                       "האחים האגדיים לבית שמידר הלא הם יועז ואליפז. האחים ברומר של המגרש מול האולם",
                       "האחים האגדיים לבית חודדה הלא הם נוי וחרוי. אחד הכינויים המבזים ביותר שהומצאו בכפר",
                       "מעריץ גדול של עופר שלח. הייטר גדול של שמעון",
                       "בית למתנות יומולדת זולות במחיר מופקע. דודו הגיע הזמן להוריד מהקיר את השעון מכבי חיפה שנקנה שם ב97",
                       "שם נעוריו של ראש המועצה המכהן. אדם בעל חזון גדול וקעקוע קטן",
                       'עירית הספרנית האגדית. שנים שלא נמצאה מחליפה ראויה עד שהגיעה אחותה של האחת והיחידה - למב"ז',
                       "כינויו המקורי של חפי, על שם הדמיון למוכר פיצוחים משיבלי. עשה את הונו על מכירת כדורים שעפו מהמגרש",
                       "בית גידולו של החציל, מייסד הפסטיפור. נצר לשושלת גרמנית עתיקה שהביאה לעולם את השניצל בצורת דינוזאור",
                       "הסנסיי הראשון של כפר תבור, גידל דורות של ג׳ודוקאים בינוניים. יש הטוענים שזה בכלל לא ספורט",
                       "מהאבות המייסדים של הקולינאריה הצ׳רקסית. פעם בית לשווארמה אגדית, היום חיית אינסטגרם וחלוג׳ים",
                      ];
...
function pickMessage() {
    ...
    if (wordCount === 2) {
        messageArray = ['נסכם את ההצלחה בשתי מילים: יופי טופי','נולדת לתבורדעל','תבורדעל מודה לך על משחק מופתי','טובים השניים מן האחד (ניחושים כאילו)', 'גאוני', 'אמאל׳ה הצלחת מהר', 'אחלה תוצאה שבעולם', 'נראה שהלך מדהים', '!!!טירוף', 'שני ניחושים? קטונתי', 'יש לך מוח ענק', 'תוצאה מפחידה', 'וואו פשוט וואו', 'בגלגול הקודם היית מילונאי', "שני ניחושים יצאו לדרך בים בם בום", 'אין לנו מה לומר, הצלחת', 'מזל של מתחילים', 'הלכת אול אין וזה השתלם אחושקשוקי', 'לא רואים אבל אני משתחווה','מוצלח, מאוד מאוד מוצלח']
    }
    if (wordCount === 3) {
...
function shareResults() {
    let shareResult = `תבורדעל # ${numOfWordale}` + "\n";
    ...
    shareResult = shareResult + "\n" + "תבורדעל בעברית:" + "\n" + "https://zfira.github.io/tavordle";
